<?php
	...
	$pageName = "Feature";
	$parentPageURL = 'feature-master.php';
	$pageURL = 'feature-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$result = $admin->addFeature($_POST, $_FILES);
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueFeatureById($id);
	}
	...
	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateFeature($_POST, $_FILES);
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="form-group row">
										<div class="col-md-3">
											<label>Feature <em>*</em></label>
											<input type="text" name="feature" required class="form-control" value="<?php echo isset($_GET['edit']) ? $data['feature'] : ""; ?>">
										</div>
										<div class="col-sm-3 mgbstm">
											<label>Image <em>*</em></label>
											<input type="file" class="form-control file" name="image_name" id="image_name" data-image-index="0">
											<span class="help-text">
												Files must be less than <strong>2 MB</strong>.<br>
												Allowed file types: <strong>jpeg, jpg, png </strong>.<br>
												Images must be exactly <strong>100 X 100</strong> pixels.
											</span>
											<?php
												if(isset($_GET['edit']) and !empty($data['image_name'])) {
											...
											?>
													<br><img src="../images/products/<?php echo $file_name.'_crop.'.$ext ?>" width="100"  />
											<?php
												}
											?>
										</div>
