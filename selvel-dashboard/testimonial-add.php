<?php
	...
	$parentPageURL = 'testimonials.php';
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-md-3">
											<label>Testimonial <em>*</em></label>
											<textarea rows="5" name="testimonial" id="testimonial" class="form-control"> <?php if(isset($_GET['edit'])){ echo $data['testimonial']; } ?></textarea>
										</div>
										<div class="col-md-3">
											<label>User Location <em>*</em></label>
											<input type="text" name="location" value="<?php if(isset($_GET['edit'])) { echo $data['location']; } ?>" class="form-control" required />
