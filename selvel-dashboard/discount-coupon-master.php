<?php
	...
	$admin->checkUserPermissions('coupon_view', $loggedInUserDetailsArr);

	$pageName = "Discount Coupon";
	$pageURL = 'discount-coupon-master.php';
	$addURL = 'discount-coupon-add.php';
	$deleteURL = 'discount-coupon-master.php';
	...
	if(isset($_GET['delId']) && !empty($_GET['delId']) ){
		...
		$admin->deleteDiscountCoupon($delId);
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('coupon_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><?php echo $row['coupon_type']=='amount' ? '<i class="fa fa-rupee"></i> '.$row['coupon_value'] : $row['coupon_value'].' %'; ?></td>
											...
											<td>
												<?php
													if(in_array('coupon_update',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
														<?php if($row['active']==1) { ?>
												...
												?>
												<?php
													if(in_array('coupon_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
