<?php
	...
	$admin->checkUserPermissions('banner_view', $loggedInUserDetailsArr);
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('banner_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										...
										$url =  BASE_URL."/images/slider-banner/".$file_name.'.'.$ext;
								?>
										<tr>
											<td><?php echo $x++ ?></td>
											...
											<td>
												<?php
													if(in_array('banner_update',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
														<?php if($row['active']==1) { ?>
												...
												<?php
													...
													if(in_array('banner_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
