								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-3">
											...
											<br>
											<?php if(isset($_GET['edit'])){
												$file_name1 = str_replace('', '-', strtolower( pathinfo($data['subcat_image'], PATHINFO_FILENAME)));
												$ext1 = pathinfo($data['subcat_image'], PATHINFO_EXTENSION);
											?>
													<img src="../images/slider-banner/<?php echo $file_name1.'.'.$ext1 ?>" width="100"  />
											<?php
												}
											?>
										</div>
