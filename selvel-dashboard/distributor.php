<?php
	...
	$admin->checkUserPermissions('distributor_enquiry_view', $loggedInUserDetailsArr);

	$pageName = "Distributors Enquiries";
	$pageURL = 'distributor.php';
	//$addURL = 'review-add.php';
	$deleteURL = 'distributor.php';
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td>
												<?php
													if(in_array('distributor_enquiry_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
