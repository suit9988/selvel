<?php
	...
	$admin->checkUserPermissions('refund_cms', $loggedInUserDetailsArr);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			//update to database
			$result = $admin->updateCMS($_POST, 'return_policy');
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<div class="col-sm-12">
											...
											<textarea name="content" rows="7" id="content"><?php echo $data['return_policy']; ?></textarea>
										</div>
									</div>
								</div>
							</div>
