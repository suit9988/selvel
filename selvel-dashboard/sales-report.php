<?php
	...
	$admin->checkUserPermissions('sales_product', $loggedInUserDetailsArr);

	$pageName = "Sales Report";
	$pageURL = 'sales-report.php';
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)) {
										...
										$unitPrice = $row['customer_price'];
										$unitDiscountedPrice = $row['customer_discount_price'];
								...
								?>
										<tr>
											...
											<td><?php echo $productDetails['product_code']; ?></td>
											<td>
												<i class="fa fa-rupee"></i>
												<?php echo $displayPrice; ?></td>
											<td><?php echo $quantity; ?></td>
											<td><i class="fa fa-rupee"></i> <?php echo $tax; ?></td>
