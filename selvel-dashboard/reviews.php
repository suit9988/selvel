<?php
	...
	$admin->checkUserPermissions('review_view', $loggedInUserDetailsArr);

	$pageName = "Reviews";
	$pageURL = 'reviews.php';
	$addURL = 'review-add.php';
	$deleteURL = 'reviews.php';
	$tableName = 'reviews';
	...
	if(isset($_GET['status']) && isset($_GET['status']) && !empty($_GET['active_id']) && !empty($_GET['active_id'])){
		...
		$details = $admin->getUniqueReviewById($active_id);
	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			...
			<div class="content container-fluid">
				...
				<?php } ?>
				<div class="row" id="centerpositonLefts">
					<div class="col-md-12">
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td>
												<?php
													if(in_array('review_update',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
													<?php if($row['active']==1) { ?>
												...
												?>
												<?php
													if(in_array('review_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
