<?php
	...
	$admin->checkUserPermissions('least_sold_product', $loggedInUserDetailsArr);

	$pageName = "Least Sold Product";
	$pageURL = 'least-sold-product.php';
	...
	$sql = "select product_id, size, color, COUNT(product_id) as prodCount from ".PREFIX.$tableName." ".$whereCond." group by product_id, size, color order by prodCount";
