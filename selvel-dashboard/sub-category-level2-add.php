<?php
	...
	$parentPageURL = 'sub-category-level2.php';
	$pageURL = 'sub-category-level2-add.php';
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {
			$subcat_id = trim($admin->escape_string($admin->strip_all($_POST['category_id'])));

			$result = $admin->addSubCategoryLevel2($_POST, $_FILES);
			header("location:".$pageURL."?registersuccess&subcat_id=".$subcat_id);
			exit;
		}
	}
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueSubCategoryLevel2ById($id);
	}
	...
	if(isset($_POST['id']) && !empty($_POST['id'])) {
		if($csrf->check_valid('post')) {
			...
			$result = $admin->updateSubCategoryLevel2($_POST, $_FILES);
			header("location:".$pageURL."?updatesuccess&edit&id=".$id."&subcat_id=".$subcat_id);
			exit;
		}
	}
?>
					...
					<div class="row align-items-center">
						<div class="col">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="<?php echo $parentPageURL."?subcat_id=".$subcat_id; ?>"><?php echo $pageName; ?></a></li>
						...
						<div class="col-auto float-right ml-auto">
							<a href="<?php echo $parentPageURL.'?subcat_id='.$subcat_id; ?>" class="btn add-btn"><i class="fa fa-arrow-left"></i> Back to <?php echo $pageName; ?></a>
						</div>
					</div>
				</div>
				<!-- /Page Header -->
					...
					<div class="col-lg-12">
						<form action="" id="form" method="post" enctype="multipart/form-data" autocomplete="off">
							...
							<div class="form-actions text-right">
								<input type="hidden" name="category_id" value="<?php echo $subcat_id; ?>" />
