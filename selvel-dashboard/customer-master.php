<?php
	...
	$admin->checkUserPermissions('customer_view', $loggedInUserDetailsArr);

	$pageName = "Customer";
	$pageURL = 'customer-master.php';
	$addURL = 'customer-add.php';
	$deleteURL 	= 'customer-master.php';
	$tableName = 'customers';
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('customer_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><?php echo (($row['user_verified']==1) ? "Yes" : "No"); ?></td>
											<td>
												<a href="<?php echo $pageURL ?>?status=<?php echo $row['active'];?>&active_id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to update status?');" title="Click to Change Product Status" ><?php echo (($row['active']==1) ? "Active" : "Inactive"); ?></a>
											</td>
											<td>
												<?php /*if($row['active']==1) { ?>
												...
												<?php if(in_array('order_view',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
													<a class="btn-transition btn" href="order.php?search&customer_id=<?php echo $row['id']; ?>" title="View Orders">   <i class="fa fa-shopping-cart"></i> </a>
												<?php } ?>
												<a class="btn-transition btn" href="customer-address.php?customer_id=<?php echo $row['id']; ?>" title="View Address Book">   <i class="fa fa-address-book"></i> </a>
												<?php /*
