<?php
	...
	$pageName = "Size";
	$pageURL = 'size-master.php';
	$addURL = 'size-add.php';
	$deleteURL = 'size-master.php';
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('size_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td>
												<?php
													if(in_array('size_update',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
														<?php if($row['active']==1) { ?>
												...
												<?php
													...
													if(in_array('size_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
