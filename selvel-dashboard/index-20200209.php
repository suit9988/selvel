	...
	if(isset($_POST['upload'])) {
		...
		while(($fileop = fgetcsv($handle,1000,",")) != false) {
			if($j++!=1) {
				...
				$description = $admin->escape_string($admin->strip_all($fileop[$i++]));
				...
				/* $size1 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_price1 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_discount_price1 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$availability1 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$color1 = $admin->escape_string($admin->strip_all($fileop[$i++]));

				$size2 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_price2 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_discount_price2 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$availability2 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$color2 = $admin->escape_string($admin->strip_all($fileop[$i++]));

				$size3 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_price3 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_discount_price3 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$availability3 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$color3 = $admin->escape_string($admin->strip_all($fileop[$i++]));

				$size4 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_price4 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_discount_price4 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$availability4 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$color4 = $admin->escape_string($admin->strip_all($fileop[$i++]));

				$size5 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_price5 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$customer_discount_price5 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$availability5 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$color5 = $admin->escape_string($admin->strip_all($fileop[$i++]));
				$feature5 = $admin->escape_string($admin->strip_all($fileop[$i++])); */
				//exit();
				...
				$sql = "INSERT INTO ".PREFIX."product_master(`product_name`, `product_code`, `hsn_code`, `tax`, `description`, `active`, page_title, meta_keyword, meta_description, `permalink`) VALUES ('".$product_name."', '".$product_code."', '".$hsn_code."','".$tax."','".$description."', '".$active."', '".$page_title."', '".$meta_keyword."', '".$meta_description."', '".$permalink."')";
				$admin->query($sql);
				...
				/* if($size1){
					...
					$sql = "INSERT INTO ".PREFIX."product_sizes(`product_id`, `permalink`, `size`, `customer_price`, `customer_discount_price`, `available_qty`, `productcolor`) VALUES ('".$product_id."', '".$permalink."', '".$size1."', '".$customer_price1."','".$customer_discount_price1."','".$availability1."', '".$color1."')";
					$admin->query($sql);
				}
				...
				if($size2){
					...
					$sql = "INSERT INTO ".PREFIX."product_sizes(`product_id`, `permalink`, `size`, `customer_price`, `customer_discount_price`, `available_qty`, `productcolor`) VALUES ('".$product_id."', '".$permalink."', '".$size2."', '".$customer_price2."','".$customer_discount_price2."','".$availability2."', '".$color2."')";
					$admin->query($sql);
				}
				...
				if($size3){
					...
					$sql = "INSERT INTO ".PREFIX."product_sizes(`product_id`, `permalink`, `size`, `customer_price`, `customer_discount_price`, `available_qty`, `productcolor`,features_color) VALUES ('".$product_id."', '".$permalink."', '".$size3."', '".$customer_price3."','".$customer_discount_price3."','".$availability3."', '".$color3."', '".$feature3."')";
					$admin->query($sql);
				}
				...
				if($size4){
					...
					$sql = "INSERT INTO ".PREFIX."product_sizes(`product_id`, `permalink`, `size`, `customer_price`, `customer_discount_price`, `available_qty`, `productcolor`) VALUES ('".$product_id."', '".$permalink."', '".$size4."', '".$customer_price4."','".$customer_discount_price4."','".$availability4."', '".$color4."')";
					$admin->query($sql);
				}
				...
				if($size5){
					...
					$sql = "INSERT INTO ".PREFIX."product_sizes(`product_id`, `permalink`, `size`, `customer_price`, `customer_discount_price`, `available_qty`, `productcolor`) VALUES ('".$product_id."', '".$permalink."', '".$size5."', '".$customer_price5."','".$customer_discount_price5."','".$availability5."', '".$color5."')";
					$admin->query($sql);
				} */
				...
				$qtyArr = explode('|', $customer_discount_price);
