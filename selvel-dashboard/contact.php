<?php
	...
	$admin->checkUserPermissions('contact_cms', $loggedInUserDetailsArr);
	...
	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			//update to database
			$result = $admin->updatecontactmap($_POST, 'map');
							...
							<div class="card">								
								<div class="card-body">	
									<div class="form-group row">
										<div class="col-md-12">
											<label>Map Url </label>
											<input type="text" name="map" value="<?php echo $data['map'];  ?>" class="form-control" />
											<br><br>
										</div>
										...
										<div class="col-md-3"><br>
											...
											<input type="text" name="fb" value="<?php echo $data['fb'];  ?>" class="form-control" />
										</div>
										<div class="col-md-3"><br>
											<label>Twitter Link</label>
											<input type="text" name="twit" value="<?php echo $data['twit'];  ?>" class="form-control" />
										</div>
										<div class="col-md-3"><br>
										...
										<div class="col-md-3"><br>
											...
											<input type="text" name="insta" value="<?php echo $data['instagram'];  ?>" class="form-control" />
										</div>
									</div>
