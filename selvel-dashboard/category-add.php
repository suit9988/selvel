								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-3">
											...
											<?php
											$sql_att = "select * from slv_attribute_master";
											$results_att = $admin->query($sql_att);
											while($row_att = $admin->fetch($results_att)){
											?>
												<option value="<?php echo $row_att['id']; ?>" > <?php echo $row_att['attribute_name']; ?></option>
											<?php } ?>
											</select>
										</div>
										<div class="col-sm-3">
									...
									<div class="form-group row">
										<div class="col-sm-3">
											<label>Category Background Image <em>*</em></label>
											<input type="file" class="form-control" name="main_image" id="main_image" accept="image/png" id="" data-image-index="0"  />
											...
											?>
													<img src="../images/slider-banner/<?php echo $file_name.'.'.$ext ?>" width="100"  />
											<?php
												}
											?>
										</div>
										<div class="col-sm-3">
											<label>Home Page Small Image <em>*</em></label>
											<input type="file" class="form-control" name="small_image" id="main_image" accept="image/png" id="" data-image-index="0" />
											<span class="help-text">
												Files must be less than <strong>2 MB</strong>.<br>
												Allowed file types: <strong>png </strong>.<br>
												Images must be exactly <strong>284 X 290</strong> pixels.
											</span>
											<br>
											<?php if(isset($_GET['edit'])){
												$file_name1 = str_replace('', '-', strtolower( pathinfo($data['cat_image'], PATHINFO_FILENAME)));
												$ext1 = pathinfo($data['cat_image'], PATHINFO_EXTENSION);
											?>
												<img src="../images/slider-banner/<?php echo $data['cat_image']; ?>" width="100"  />
											<?php
												}
											?>
										</div>
