<?php
	...
	$deleteURL = 'attribute-master.php';
	...
	if(isset($_GET['delId']) && !empty($_GET['delId']) ){
		...
		$admin->deleteAttributeById($delId);
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('attribute_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								<?php
									...
									while($row = $admin->fetch($results)){
										$sql = "SELECT * FROM ".PREFIX."category_attribute_list as cal left join ".PREFIX."category_master as cm on cal.category_id = cm.id where cal.attribute_id='".$row['id']."'";
								...
								?>
										<tr>
											...
											<td>
												...
												?>
												<?php
													if(in_array('attribute_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
