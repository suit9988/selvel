<?php
	...
	$admin->checkUserPermissions('gifting_enquiry_view', $loggedInUserDetailsArr);

	$pageName = "Corporate Gifting Enquiries";
	$pageURL = 'corporate.php';
	$addURL = 'review-add.php';
	$deleteURL = 'corporate.php';
	$tableName = 'corporate_gifting';
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td style="text-transform: capitalize;"><?php echo $row['purpose']; ?></td>
											<td><?php echo nl2br($row['msg']); ?></td>
											<td><?php echo date("d-m-Y H:i:s", strtotime($row['created'])); ?></td>
											<td>
												<?php
													if(in_array('gifting_enquiry_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
