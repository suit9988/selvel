<?php
	...
	$admin->checkUserPermissions('color_view', $loggedInUserDetailsArr);

	$pageName = "Color";
	$pageURL = 'color-master.php';
	$addURL = 'color-add.php';
	$deleteURL = 'color-master.php';
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('color_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td><img src="../images/color/<?php echo $row['image']; ?>" width="25" /></td>
											<td>
												<?php
													if(in_array('color_update',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
														<?php if($row['active']==1) { ?>
												...
												?>
												<?php
													if(in_array('color_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
