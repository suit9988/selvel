<?php
	...
	$admin->checkUserPermissions('delivery_view', $loggedInUserDetailsArr);

	$pageName = "Delivery Pincode";
	$pageURL = 'delivery-pincode.php';
	$addURL = 'delivery-pincode-add.php';
	$deleteURL = 'delivery-pincode.php';
	$tableName = 'pincode';
	...
	if(isset($_GET['delId']) && !empty($_GET['delId']) ){
		...
		$admin->deleteDeliveryPincode($delId);
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row align-items-center">
						...
						<?php if(in_array('delivery_create',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') { ?>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td>
												<?php
													if(in_array('delivery_update',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
												...
												?>
												<?php
													if(in_array('delivery_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
