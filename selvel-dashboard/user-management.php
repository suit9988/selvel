<?php
	...
	$pageName = "Employee";
	$pageURL = 'user-management.php';
	$addURL = 'user-management-add.php';
	$deleteURL = 'user-management.php';
	$tableName = 'admin';

	$sql = "select * from ".PREFIX.$tableName." where role <> 'super' and is_deleted=0 order by id DESC";
	...
	if(isset($_GET['delId']) && !empty($_GET['delId']) ){
		...
		$admin->deleteUserManagementById($delId);
