<?php
	...
	$admin->checkUserPermissions('newsletter_view', $loggedInUserDetailsArr);

	$pageName = "Newsletter Subscription";
	$pageURL = 'newsletter.php';
	$addURL = 'review-add.php';
	$deleteURL = 'newsletter.php';
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td>
												<?php
													if(in_array('newsletter_delete',$userPermissionsArray) or $loggedInUserDetailsArr['role']=='super') {
												?>
