		...
		<div class="container breadcum-header">
			...
			<ul>
				...
				<li>
					...
					<a href="checkout.php" class="current-page" style="cursor: pointer;pointer-events: visible;">Information</a> 
							...
							<div class="billing-add match" style="">
								...
								<div class="box-inner-ctn">
									...
									<div class="priviewcheckout">
										...
										<div class="row mguskodekh">
											...
											<div class="col-md-2">
												...
												<p class="conpss"><strong>Contact</strong></p>
											...
											<div class="col-md-2">
												...
												<a href="checkout.php" class="linktobsp">Edit</a>
										...
										<div class="row mguskodekh">
											...
											<div class="col-md-2">
												...
												<p class="conpss"><strong>Ship to</strong></p>
												...
												<div class="content-box__row">
													...
													<div class="radio-wrapper" >
														...
														<div class="radio__input">
															...
															<input style="display: block;" class="input-radio-plus" name="frosomepayment" type="radio" checked="checked">
									...
									<div class="checkout-btns flestarvatas">
										 ...
										 <a href="checkout.php" class="shop-now-btn dark-yellow-btn text-center">Return to Information</a> 

										<button class="shop-now-btn purple-btn text-center sbtbnall"><a href="checkout-payment.php" style="color:#fff">Payment</a></button>
