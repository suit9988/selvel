...
<!-- ONE COLUMN SECTION -->
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #ddd;">
   <tr>
	...
	<tr>
        <td bgcolor="#453194" align="center" style="padding: 15px;" class="section-padding">
            <!--[if (gte mso 9)|(IE)]>
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="500">
            <tr>
            <td align="center" valign="top" width="500">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">Hi <?php echo $newCustomerDetails['first_name']; ?>,</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <?php if(isset($newCustomerDetails['verification_link']) && !empty($newCustomerDetails['verification_link'])){ ?>
                                       ...
                                       <a href="<?php echo BASE_URL."/verify-customer-email.php?v=".$newCustomerDetails['verification_link']; ?>" style="font-size:14px; color:#2a1966;">Verify my email address</a>
