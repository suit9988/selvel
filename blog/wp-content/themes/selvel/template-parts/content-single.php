...
?>
	  ...
	  <header class="entry-header">
					...
					<?php the_title( sprintf( '<h1 class="inner"><a href="%s" rel="bookmark">', esc_url( get_permalink() ) ), '</a></h1>' ); ?>
			...
			<div class="posted-on inner">Posted on <time datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished"><?php echo get_the_date(); ?></time></div>
