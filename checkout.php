...
<body class="inner-page dashboard-pages chekout-order-summary-page" id="address-book">
	...
	<main class="main-inner-div">  
		...
		<div class="container breadcum-header" style="padding: 8px 0px; border: none">
			<center>
			<ul >
				<li>

					<a href="https://mockupbw.com/2021/selvel/cart.php" class="current-page" style="cursor: pointer;pointer-events: visible;">Cart</a> 
							...
							<?php if(!$loggedInUserDetailsArr = $functions->sessionExists()) { ?>
								...
								<div class="flelops">
									...
									<div>
										...
										<p class="already">Already have an account? <a class="green-text" href="login.php?redirect=checkout.php">Login Here</a></p>
								...
								<div class="box-inner-ctn">
									...
									<div class="new-frosm">
										...
										<div class="form-group">
											...
											<input type="email" class="form-control" placeholder="Email" name="customer_email" value="<?php if(isset($addressDetails['customer_email'])){ echo $addressDetails['customer_email']; } else if($loggedInUserDetailsArr) { echo $loggedInUserDetailsArr['email']; } else { echo ""; } ?>">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="Phone Number" name="customer_contact" value="<?php if(isset($addressDetails['customer_contact'])){ echo $addressDetails['customer_contact']; } else if($loggedInUserDetailsArr) { echo $loggedInUserDetailsArr['mobile']; } else { echo ""; } ?>">
									...
									<div class="checkout-btns">
										...
										<?php /* <a href="checkout-preview.php" class="shop-now-btn purple-btn text-center sbtbnall" >Continue to Shipping</a> */ ?>
										<a href="checkout-preview.php" class="shop-now-btn purple-btn text-center sbtbnall" ><i class="fa fa-arrow-left" style="color:#CADB2A"></i>&nbsp;&nbsp;&nbsp;Return to Cart</a>
